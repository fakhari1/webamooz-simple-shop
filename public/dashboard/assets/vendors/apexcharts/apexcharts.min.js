        ...
        w = function() {
            ...
            return r(t, [{
                ...
                value: function(t, e) {
                    ...
                    this.annoCtx.inversedReversedAxis && (o = (s - e.x) / (r / i.globals.gridWidth)), "categories" !== i.config.xaxis.type && !i.config.xaxis.convertedCatToNumeric || this.annoCtx.invertAxis || i.globals.dataFormatXNumeric || (o = this.getStringX(e.x));
                    var n = (e.x2 - a) / (r / i.globals.gridWidth);
                    return this.annoCtx.inversedReversedAxis && (n = (s - e.x2) / (r / i.globals.gridWidth)), "categories" !== i.config.xaxis.type && !i.config.xaxis.convertedCatToNumeric || this.annoCtx.invertAxis || i.globals.dataFormatXNumeric || (n = this.getStringX(e.x2)), void 0 !== e.x && null !== e.x || !e.marker || (o = i.globals.gridWidth), "x1" === t ? o : n
                }
            }, {
                key: "getStringX",
                value: function(t) {
        ...
        H = function(t) {
            ...
            return r(s, [{
                ...
                value: function(t) {
                    var e = t.color,
                        i = t.seriesName;
                    return '<div class="apexcharts-tooltip-rangebar"><div> <span class="series-name" style="color: ' + e + '">' + (i || "") + '</span></div><div> <span class="categories">' + t.ylabel + ' </span> <span class="value start-value">' + t.start + '</span> <span class="separator">-</span> <span class="value end-value">' + t.end + "</span></div></div>"
                }
            }]), s
        }(F),
        D = function() {
        ...
        B = function() {
            ...
            return r(t, [{
                ...
                value: function(t) {
                    ...
                    s.isRangeBar = "rangeBar" === a.chart.type && s.isBarHorizontal, s.hasGroups = "categories" === a.xaxis.type && a.xaxis.group.groups.length > 0, s.hasGroups && (s.groups = a.xaxis.group.groups);
                    for (var n = function() {
                    ...
                    var l = [],
                        ...
                        u = function(t) {
                            ...
                            if (n.globals.axisCharts) {
                                if ("categories" === n.config.xaxis.type || n.config.xaxis.convertedCatToNumeric)
            ...
            return r(t, [{
                ...
                value: function(t, e, i, a, s, r) {
                    var o, n = this,
                        ...
                        v = a.length,
                        m = "categories" === d.config.xaxis.type ? d.globals.dataPoints : v;
                    if (s) {
                        var y = m > 1 ? m - 1 : m;
            ...
            return r(t, [{
                ...
                value: function(t, e) {
                    ...
                    if (void 0 !== i.config.grid.column.colors && i.config.grid.column.colors.length > 0)
                        for (var l = i.globals.isBarHorizontal || "categories" !== i.config.xaxis.type && !i.config.xaxis.convertedCatToNumeric ? t : t - 1, h = i.globals.padHorizontal, c = i.globals.padHorizontal + i.globals.gridWidth / l, d = i.globals.gridHeight, g = 0, u = 0; g < t; g++, u++) u >= i.config.grid.column.colors.length && (u = 0), this._drawGridBandRect({
                            c: u,
                            x1: h,
                            y1: 0,
                            x2: c,
        ...
        Z = function() {
            ...
            return r(t, [{
                ...
                value: function() {
                    var t = this.w.globals,
                        e = this.w.config,
                        i = "numeric" === e.xaxis.type || "datetime" === e.xaxis.type || "categories" === e.xaxis.type && !t.noLabelsProvided || t.noLabelsProvided || t.isXNumeric;
                ...
                value: function() {
                    ...
                    if (t.minX === t.maxX) {
                        ...
                        } else("numeric" === e.xaxis.type || "categories" === e.xaxis.type && !t.noLabelsProvided) && (t.minX = t.minX - 2, t.initialMinX = t.minX, t.maxX = t.maxX + 2, t.initialMaxX = t.maxX)
                    }
                }
            }, {
                key: "_getMinXDiff",
